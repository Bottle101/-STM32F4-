...
void motor_Init(u32 arr, u32 psc, u32 speed)
{
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM4, ENABLE);  	//TIM12时钟使能
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE); 	//使能PORTH时钟
...
void sever_Init(u32 arr, u32 psc)
{
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE); 	//使能PORTH时钟
